...
For these who run a \LaTeX{} distribution on their system, \inlinecode{text}{old-dms.cls} can be downloaded at \url{https://github.com/sylvain-kern/old-dms}. 
...
Math environments are a bit pimped\cite{ref:einstein}. Here are some examples:
...
\inlinecode{text}{minted} does take a lot of resources, if you have many code boxes. The compilation time, especially with \TeX\textit{maker}, can be a bit long.
...
Here is \inlinecode{text}{Old DMs}'s source code. It is also avaliable at \url{https://github.com/sylvain-kern/old-dms}.
...
\begin{thebibliography}{9}	  
	...
	\bibitem{ref:einstein}
		Old-style/Antique typesetting in LaTeX/TeX - TeX - LaTeX Stack Exchange
		\url{https://tex.stackexchange.com/questions/9894/old-style-antique-typesetting-in-latex-tex}
